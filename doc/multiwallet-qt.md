...
Only requiring some minor changes is strength.cpp.
...
Changes to strength.cpp
----------------------
strength.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
