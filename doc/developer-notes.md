...
STRENGTH Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 25010.
...
However, in open source software such as STRENGTH Core, where everyone uses
...
pay attention to for reviewers of STRENGTH Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: STRENGTH Core uses tinyformat, which is type safe. Leave them out to avoid confusion
