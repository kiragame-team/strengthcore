...
This mechanism has been integrated into Bitcore-Node-STRENGTH which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/kiragame-team/insight-api-strength#web-socket-api](https://github.com/kiragame-team/insight-api-strength#web-socket-api)
* API: [https://github.com/kiragame-team/insight-api-strength#instantsend-transactions](https://github.com/kiragame-team/insight-api-strength#instantsend-transactions)
...
By default, the STRENGTH Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the STRENGTH Core daemon:
