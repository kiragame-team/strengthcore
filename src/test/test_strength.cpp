...
#define BOOST_TEST_MODULE STRENGTH Test Suite

#include "test_strength.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_strength_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
