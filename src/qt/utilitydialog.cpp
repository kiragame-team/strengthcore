    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("STRENGTH Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About STRENGTH Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  strength-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the STRENGTH in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other strength, without having your coins ever leave your wallet. \
...
These denominations are 0.01 STRENGTH, 0.1 STRENGTH, 1 STRENGTH and 10 STRENGTH -- sort of like the paper money you use every day.</li> \
...
<li>When two other strength send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://Strength.atlassian.net/wiki/display/DOC/PrivateSend\">https://Strength.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("STRENGTH Core is shutting down...") + "<br /><br />" +
