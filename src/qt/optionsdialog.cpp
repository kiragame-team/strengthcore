    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("STRENGTH-light"), QVariant("light"));
    ui->theme->addItem(QString("STRENGTH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("STRENGTH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("STRENGTH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("STRENGTH-traditional"), QVariant("trad"));
