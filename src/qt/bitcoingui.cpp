    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("STRENGTH Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STRENGTH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and strength: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About STRENGTH Core"), this);
    aboutAction->setStatusTip(tr("Show information about STRENGTH Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for STRENGTH Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STRENGTH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STRENGTH addresses"));
    ...
    openAction->setStatusTip(tr("Open a strength: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the STRENGTH Core help message to get a list with possible STRENGTH Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("STRENGTH Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to STRENGTH network", "", count));
    } else {
...
{
    QString strTitle = tr("STRENGTH Core"); // default title
