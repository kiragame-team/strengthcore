...
enum GovernanceObjectType {
    ...
    // -------------------------------
    // STRENGTHNetwork - is the root node
    STRENGTHNetwork = 1000,
    STRENGTHNetworkVariable = 1001,
    Category = 1002,
    ...
    //   --  strength that operate DAOs will own companies which can own things legally
    Group = 2000,
    User = 2001,
    Company = 2002,
