 ...
 *   milestone-status-error strength, option2, option3
 ...
 *
 *   // network
 *   CSTRENGTHNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CSTRENGTHNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSTRENGTHNetwork(UniValue objIn)
    {
...
// // can be under: STRENGTHNetwork
// //   -- signature requirements : Key1(User)
// class CSTRENGTHNetworkVariable : public CGovernanceObject
// {
// private:
