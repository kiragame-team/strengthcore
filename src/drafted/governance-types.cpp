...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "STRENGTHNetwork") type = STRENGTHNetwork;
    if(strType == "STRENGTHNetworkVariable") type = STRENGTHNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == STRENGTHNetwork) s = "STRENGTHNetwork";
    if(type == STRENGTHNetworkVariable) s = "STRENGTHNetworkVariable";
